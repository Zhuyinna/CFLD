...
_C.MODEL = CN()
_C.MODEL.PRETRAINED_PATH = "./checkpoints"
...
# add
_C.MODEL.COND_STAGE_CONFIG.RIE = CN()
_C.MODEL.COND_STAGE_CONFIG.RIE.PRETRAINED_PATH = ""
_C.MODEL.COND_STAGE_CONFIG.RIE.CTX_DIMS = [320, 320, 320, 640, 640, 640, 1280, 1280, 1280]

_C.MODEL.COND_STAGE_CONFIG.CLIP_ENCODER = CN()
_C.MODEL.COND_STAGE_CONFIG.CLIP_ENCODER.PRETRAINED_PATH = "pretrained_models/openai/clip-vit-base-patch32"
_C.MODEL.COND_STAGE_CONFIG.CLIP_ENCODER.N_CTX = 50
_C.MODEL.COND_STAGE_CONFIG.CLIP_ENCODER.CTX_DIM = 768

# _C.MODEL.COND_STAGE_CONFIG.DINO_ENCODER = CN()
# _C.MODEL.COND_STAGE_CONFIG.DINO_ENCODER.PRETRAINED_PATH = "pretrained_models/facebook/dinov2-base"
# _C.MODEL.COND_STAGE_CONFIG.DINO_ENCODER.N_CTX = 325
# _C.MODEL.COND_STAGE_CONFIG.DINO_ENCODER.CTX_DIM = 768


_C.MODEL.COND_STAGE_CONFIG.ZERO_CROSS_ATTENTION = CN()
_C.MODEL.COND_STAGE_CONFIG.ZERO_CROSS_ATTENTION.USE_ZERO_CROSS_ATTN = True
_C.MODEL.COND_STAGE_CONFIG.ZERO_CROSS_ATTENTION.USE_ATV_LOSS = False
